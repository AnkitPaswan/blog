...
  const handleItemClick = (name) => {
  ...
  return (
    <div className={`fixed right-0 top-[88px] bottom-0 w-16 md:w-20 bg-white border-l shadow-sm flex flex-col justify-between z-40 transition-transform duration-300 ${isOpen ? 'translate-x-0' : 'translate-x-full md:translate-x-0'}`}> 
      
...
              onClick={() => { handleItemClick(item.name); setSidebarOpen(false); }}
